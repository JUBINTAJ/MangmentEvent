      ...
      <div className="bg-transparent rounded-xl">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold">
            Event Name <span className="text-gray-200 text-base md:text-lg">(Venue Details)</span>
          </h2>
        </div>

        <div className="flex scrollb space-x-2 mb-6 border-[#D960B6]">
          {tabs.map((tab) => (
            <button
              key={tab}
              onClick={() => setActiveTab(tab)}
              className={`px-4 py-2 text-sm rounded-md transition-all duration-200 flex-shrink-0 whitespace-nowrap border-1 ${
                activeTab === tab ? "bg-pink-600 text-white" : "bg-transparent text-pink-400"
              }`}
            >
              {tab}
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-1">
            ...
            <div className="relative w-full">
              <input
                ...
                className="w-full p-2 pl-3 pr-10 rounded-xl border border-white text-white bg-transparent placeholder:text-sm md:placeholder:text-xl"
              />
              <ChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
            </div>

            <button className="text-sm md:text-xl text-pink-500 my-4"> Add New Coordinator</button>
              ...
              {[1, 2, 3, 4, 5].map((room) => (
                ...
                >
                  <div className="flex justify-between items-center">
                    <h4 className="text-lg md:text-2xl">Meeting Room {room}</h4>
          ...
          <div className="md:col-span-2">
            <h3 className="text-xl md:text-2xl font-medium mb-4">
              Event Name <span className="text-gray-200 text-base md:text-lg">(Venue Here)</span>
            </h3>
            <div className="bg-transparent border border-[#D960B6] p-2 rounded text-sm mb-4 flex flex-col md:flex-row md:justify-between">
              <span className="text-gray-200">Start: 12-12-2023</span>
              <span className="text-gray-200">Ends: 15-12-2023</span>
            </div>
            ...
            <div className="bg-black rounded-xl border border-[#D960B6] mt-4 w-full overflow-x-auto">
            ...
            <div className="flex justify-center mt-6">
              <button className="w-full md:w-auto bg-pink-700 text-white px-6 py-2 text-lg rounded-md hover:opacity-90">
                Save Edits
              </button>
            </div>
          </div>
